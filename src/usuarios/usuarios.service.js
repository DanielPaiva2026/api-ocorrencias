...
var UsuariosService = function () {
    ...
    var UsuariosService = _classThis = /** @class */ (function () {
        ...
        UsuariosService_1.prototype.create = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var usuarioExistente, senhaPadrao, senha_hash, usuario;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            senhaPadrao = data.senha || 'mudar@123';
                            return [4 /*yield*/, bcrypt.hash(senhaPadrao, 10)];
                        case 2:
                            senha_hash = _a.sent();
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (usuario.email === 'admin@admin.com') {
                                throw new common_1.BadRequestException('O administrador principal não pode ser excluído.');
                            }

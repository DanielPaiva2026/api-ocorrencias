                ...
                postos_de_trabalho: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            quantidade: { type: genai_1.Type.INTEGER, description: 'Quantidade de postos' },
                            cobertura_tipo: { type: genai_1.Type.STRING, description: 'Se escala B ou C: FIXO (cobre dom/feriado com posto extra), REVEZAMENTO (trabalha dom/fer, folga na semana), ou NENHUMA. Nulo se não se aplicar.' }
                        }
                    }
                }
            }
...
`;
    ...
    async createPostoManual(clienteId, data) {
